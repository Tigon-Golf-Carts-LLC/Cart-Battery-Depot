          ...
          <div>
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <Link href="/battery-selector">
                <Button 
                  size="lg" 
                  className="bg-cart-orange text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg hover:bg-orange-600 w-full min-h-[52px] sm:min-h-[56px] touch-manipulation"
                  data-testid="button-battery-selector-hero"
                >
                  <Search className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-cart-green flex-shrink-0" />
                  <span className="whitespace-nowrap">Find Your Perfect Battery</span>
                </Button>
              </Link>
              <a 
                href="tel:1-844-888-7732"
                className="bg-white text-cart-green px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg hover:bg-gray-100 transition-colors flex items-center justify-center border-2 border-white w-full min-h-[52px] sm:min-h-[56px] touch-manipulation"
            ...
            <div className="mt-4 sm:mt-5 md:mt-6 flex items-center text-blue-100 text-sm sm:text-base">
              <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-cart-green flex-shrink-0" />
            ...
            <div className="bg-white/10 p-4 sm:p-6 md:p-8 rounded-2xl backdrop-blur-sm text-center">
              <div className="bg-white/20 p-4 sm:p-6 md:p-8 lg:p-12 rounded-xl">
                <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6">
                  <div className="bg-cart-green/20 p-3 sm:p-4 rounded-lg">
                    <Battery className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-cart-green mx-auto mb-1 sm:mb-2" />
                    <div className="text-white font-semibold text-xs sm:text-sm md:text-base">Golf Cart</div>
                  </div>
                  <div className="bg-cart-blue/20 p-3 sm:p-4 rounded-lg">
                    <Truck className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-cart-blue mx-auto mb-1 sm:mb-2" />
                    <div className="text-white font-semibold text-xs sm:text-sm md:text-base">LSV/NEV</div>
                  </div>
                  <div className="bg-cart-green/20 p-3 sm:p-4 rounded-lg">
                    <Zap className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-cart-green mx-auto mb-1 sm:mb-2" />
                    <div className="text-white font-semibold text-xs sm:text-sm md:text-base">Lithium</div>
                  </div>
                  <div className="bg-cart-green/20 p-3 sm:p-4 rounded-lg">
                    <Shield className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-cart-green mx-auto mb-1 sm:mb-2" />
                    <div className="text-white font-semibold text-xs sm:text-sm md:text-base">AGM/Gel</div>
                  </div>
                </div>
              </div>
              <div className="mt-3 sm:mt-4 text-center">
                <div className="text-cart-green font-semibold text-sm sm:text-base md:text-lg">96+ Battery Configurations Available</div>
